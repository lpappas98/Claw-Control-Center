...
exports.migrateData = exports.updateHeartbeat = exports.validateConnectionToken = void 0;
 ...
 */
exports.validateConnectionToken = functions.https.onRequest(async (req, res) => {
    // Enable CORS
 ...
 */
exports.updateHeartbeat = functions.https.onRequest(async (req, res) => {
    // Enable CORS
    res.set('Access-Control-Allow-Origin', '*');
    res.set('Access-Control-Allow-Methods', 'POST, OPTIONS');
    res.set('Access-Control-Allow-Headers', 'Content-Type');
