...
## Role
Frontend Developer - React, UI components, user interfaces
...
## API Endpoints
- Get tasks: `GET /api/tasks?lane=queued&owner=dev-2`
- Update task: `PUT /api/tasks/{id}`
- Bridge: `http://192.168.1.51:8787`

## Specialization
Frontend work: React, TypeScript, Vite, shadcn/ui, Tailwind CSS, UI/UX
