 ...
 */
export const listAgentProfiles = functions.https.onRequest(async (req, res) => {
  if (handleCors(req, res)) return
 ...
 */
export const createAgentProfile = functions.https.onRequest(async (req, res) => {
  if (handleCors(req, res)) return
 ...
 */
export const updateAgentProfile = functions.https.onRequest(async (req, res) => {
  if (handleCors(req, res)) return
 ...
 */
export const deleteAgentProfile = functions.https.onRequest(async (req, res) => {
  if (handleCors(req, res)) return
